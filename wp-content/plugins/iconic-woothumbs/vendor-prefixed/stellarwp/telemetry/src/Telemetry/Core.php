 ...
 * Modified by James Kemp on 16-April-2024 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */

namespace Iconic_WooThumbs_NS\StellarWP\Telemetry;

use Iconic_WooThumbs_NS\StellarWP\ContainerContract\ContainerInterface;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Admin\Admin_Subscriber;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Admin\Resources;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Contracts\Data_Provider;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Data_Providers\Debug_Data;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Exit_Interview\Template;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Opt_In\Status;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Telemetry\Telemetry;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \Iconic_WooThumbs_NS\StellarWP\ContainerContract\ContainerInterface
	 */
