...
namespace Iconic_WooThumbs_NS\StellarWP\Telemetry\Exit_Interview;
...
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Config;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Contracts\Template_Interface;
use Iconic_WooThumbs_NS\StellarWP\Telemetry\Core;
...
class Template implements Template_Interface {
	 ...
	 * @since 1.0.0
	 *
	 * @var \Iconic_WooThumbs_NS\StellarWP\ContainerContract\ContainerInterface
	 */
	protected $container;
	 ...
	 * @since 1.0.0
	 *
	 * @param \Iconic_WooThumbs_NS\StellarWP\ContainerContract\ContainerInterface $container The container.
	 */
