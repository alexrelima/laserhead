...
class Validation_Response {
	...
	private function parse() {
		...
		$this->expiration  = isset( $this->response->expiration ) ? $this->response->expiration : __( 'unknown date', 'iconic-woothumbs' );
