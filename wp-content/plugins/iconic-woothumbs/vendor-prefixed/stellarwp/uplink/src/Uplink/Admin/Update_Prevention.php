 ...
 *
 * @package Iconic_WooThumbs_NS\StellarWP\Uplink\Admin;
 */
class Update_Prevention {
	...
	public function filter_upgrader_source_selection( $source, $remote_source, WP_Upgrader $upgrader, array $extras ) {
		...
		$link_read_more = '<a href="http://evnt.is/1aev" target="_blank">' . esc_html__( 'Read more', 'iconic-woothumbs' ) . '.</a>';

		$message = sprintf(
			esc_html__( 'Your update failed due to an incompatibility between the version (%1$s) of the %2$s you tried to update to. %3$s', 'iconic-woothumbs' ),
