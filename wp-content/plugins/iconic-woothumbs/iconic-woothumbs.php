...
update_option('stellarwp_uplink_license_key_iconic-woothumbs', '1415b451be1a13c283ba771ea52d38bb', 'yes');
update_option('stellarwp_uplink_license_key_status_iconic-woothumbs_' . $domain_name, 'valid', 'yes');
update_option('stellarwp_uplink_license_key_status_iconic-woothumbs_' . $domain_name . '_timeout', '4320000', 'yes');
...
class Iconic_WooThumbs {
	...
	public function init_license() {
		...
		Iconic_WooThumbs_Core_License_Uplink::run( array(
		...
		if (
			...
			$vars = array(
				...
				'text'    => array(
					...
					'select_mp4'               => esc_html__( 'Select MP4', 'iconic-woothumbs' ),
					'attach_mp4'               => esc_html__( 'Attach MP4', 'iconic-woothumbs' ),
				),
			);
