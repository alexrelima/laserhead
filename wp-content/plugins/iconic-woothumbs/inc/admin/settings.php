...
function iconic_woothumbs_settings( $wpsf_settings ) {
	...
	$wpsf_settings['sections'][] = array(
		...
		'fields'              => array(
			...
			array(
				...
				'subtitle' => esc_html__( 'When enabled, gallery images will be used as poster images for both YouTube/Vimeo and MP4 videos. Uses the image size defined in Display Settings > Image Sizes > Large Image Size.', 'iconic-woothumbs' ),
				'type'     => 'select',
				'default'  => '0',
				'choices'  => array(
					'1' => esc_html__( 'Yes', 'iconic-woothumbs' ),
	...
	$wpsf_settings['sections'][] = array(
		'tab_id'              => 'media',
		'section_id'          => 'mp4',
		'section_title'       => esc_html__( 'MP4 Settings', 'iconic-woothumbs' ),
		'section_description' => '',
		'section_order'       => 0,
		'fields'              => array(
			array(
				'id'       => 'lazyload',
				'title'    => esc_html__( 'Lazyload MP4 videos?', 'iconic-woothumbs' ),
