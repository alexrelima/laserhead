...
class Iconic_WooThumbs_Media {
	...
	public static function get_mp4_embed( $media_url = null, $attachment_id = null ) {
		...
		$return = sprintf(
			'<video class="iconic-woothumbs-responsive-media__manual-embed iconic-woothumbs-plyr intrinsic-ignore %s" %s data-poster-gallery="%s" data-poster-fullscreen="%s" data-aspect-ratio="%s" data-orientation="%s" preload="%s"><source src="%s" type="video/mp4"></video>',
