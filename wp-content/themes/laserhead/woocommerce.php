...
<?php if(is_product_category()){ ?>    
	<div class="container">
		<div class="row">
				<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-3 filtro_collum woo-marge">
					<h2 class="page-title-in title-left">Filtros</h2>
					<?php if ( dynamic_sidebar('widget_woocommerce') ) : else : endif; ?>

				</div>  
				<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-9 text-content woo-marge">
